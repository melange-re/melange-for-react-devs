...
Discount tests
  ...
  ok 6 - 3 burgers of different price, discount of second one
    ---
    ...
  # Subtest: No burger that has at least one of every topping, return None
  ok 7 - No burger that has at least one of every topping, return None
    ---
    ...
  # Subtest: One burger that has at least one of every topping, return Some(15.675)
  ok 8 - One burger that has at least one of every topping, return Some(15.675)
    ---
    ...
  1..8
  # tests 8
